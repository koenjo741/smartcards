                                                            ...
                                                            const stickyOffset = isOffRight ? Math.max(0, Math.min(renderLayout.width - minTitleWidth, barRight - viewportRight + 12)) : 0;
                                                                ...
                                                                return (
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <div className="flex justify-between items-center text-[14.6px] text-blue-100 whitespace-nowrap overflow-hidden w-full relative h-full pointer-events-none z-10" style={{ fontWeight: 500 }}>
                                                                            <span className="truncate pr-4 flex-1 select-none ml-1">{card.title}</span>
